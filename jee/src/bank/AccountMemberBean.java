...
public class AccountMemberBean {	
	...
	public AccountMemberBean(String name,String id, String pw,String ssn) {
	...
	public AccountMemberBean(int accountNo,int money,String id,String pw,String name,String regDate,String ssn) {
